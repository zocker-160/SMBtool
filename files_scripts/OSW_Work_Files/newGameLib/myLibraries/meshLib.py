...
def setBox(box,meshList):
	...
	sk=min(skX,skY,skZ)
	trX=(box[3]+box[0])/2-(max(E[0])+min(E[0]))/2
	trY=(box[4]+box[1])/2-(max(E[1])+min(E[1]))/2
	trZ=(box[5]+box[2])/2-(max(E[2])+min(E[2]))/2
	print trX,trY,trZ
	
	for mesh in meshList:
		for n in range(len(mesh.vertPosList)):
			x,y,z=mesh.vertPosList[n]
			mesh.vertPosList[n]=[trX,trY,trZ]
		for n in range(len(mesh.vertPosList)):
			x,y,z=mesh.vertPosList[n]
				...
				for i,mesh in enumerate(self.meshList):
					for j,mat in enumerate(mesh.matList):
						for line in lines:
							...
							if len(values)==3:
								if values[0]==str(i) and values[1]=='d':mat.diffuse=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[1]=='n':mat.normal=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[1]=='s':mat.specular=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[1]=='a':mat.alpha=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[1]=='o':mat.ao=self.dirname+os.sep+values[2].split('"')[1]
								
								if values[0]==str(i) and values[1]=='d1':mat.diffuse1=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[1]=='d2':mat.diffuse2=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[1]=='n1':mat.normal1=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[1]=='n2':mat.normal2=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[1]=='e':mat.emit=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[1]=='b':mat.bump=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[1]=='t':mat.trans=self.dirname+os.sep+values[2].split('"')[1]
							if len(values)==4:
								if values[0]==str(i) and values[3]==str(j) and values[1]=='d':mat.diffuse=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[3]==str(j) and values[1]=='n':mat.normal=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[3]==str(j) and values[1]=='s':mat.specular=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[3]==str(j) and values[1]=='a':mat.alpha=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[3]==str(j) and values[1]=='o':mat.ao=self.dirname+os.sep+values[2].split('"')[1]
								
								if values[0]==str(i) and values[3]==str(j) and values[1]=='d1':mat.diffuse1=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[3]==str(j) and values[1]=='d2':mat.diffuse2=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[3]==str(j) and values[1]=='n1':mat.normal1=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[3]==str(j) and values[1]=='n2':mat.normal2=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[3]==str(j) and values[1]=='e':mat.emit=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[3]==str(j) and values[1]=='b':mat.bump=self.dirname+os.sep+values[2].split('"')[1]
								if values[0]==str(i) and values[3]==str(j) and values[1]=='t':mat.trans=self.dirname+os.sep+values[2].split('"')[1]
				for i,mesh in enumerate(self.meshList):
					for j,mat in enumerate(mesh.matList):
						for line in lines:
							values=line.strip().split(':')
...
class Mesh():
	...
	def buildMesh(self,mesh,mat,meshID):
		...
		#except:print 'WARNING:self.addSkin:',mesh.name
	...
	def draw(self): 
		...
		self.name=str(self.sceneIDList.meshID)+'-0-'+str(self.sceneIDList.objectID)
		self.addFaces() 
		if self.SPLIT==False:
			self.addMesh()	
